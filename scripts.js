window.addEventListener("load", currentNumber);
...
function currentNumber() {
  var current = document.querySelector(".currentNumber");
  var rangeInput = document.querySelector(".rangeInput");
  var extNumber = document.querySelector(".extNumber");

  rangeInput.addEventListener("input", (event) => {
    current.value = rangeInput.value;
    extNumber.value = current.value.extenso();
  });
}
